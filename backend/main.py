...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:5174",
        "http://127.0.0.1:5174",
        "https://bg-p1-frontend.onrender.com"
    ],
            ...
            try:
                ...
                for hotel in agoda_results:
                    transformed_hotel = Hotel(
                        ...
                        rating=HotelRating(
                            score=float(hotel['hotel_rating']) if hotel['hotel_rating'] != "N/A" else None,
                            reviews=None  # Agoda scraper doesn't provide review count
                        ),
                        stars=None,  # Agoda rating is already in the rating field
                        location=original_location,
