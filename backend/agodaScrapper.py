...
async def search_agoda_homepage(page, location: str, check_in_date: str, check_out_date: str, adults: int):
    """
...
async def agoda_scraper(
    ...
    try:
        ...
        async with async_playwright() as p:
            ...
            await search_agoda_homepage(page, location, check_in_date, check_out_date, adults)
